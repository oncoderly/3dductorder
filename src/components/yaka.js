// Yaka - Taper prizma parçası
import * as THREE from 'three';
import { BasePart } from './BasePart.js';

export class Yaka extends BasePart {
  ...
  initDefaultParams() {
    ...
    // Yaka'ya özel parametreler
    this.defaultParams = {
      ...this.defaultParams,

      // Boyutlar (cm)
      W1: 35,         // Bitiş genişlik
      H1: 20,         // Yükseklik
      W2: 20,         // Başlangıç genişlik
      L: 20,          // Uzunluk
      ...
      groups: [
        {
          ...
          params: [
            ...
            { key: 'H1', label: 'H1 (yükseklik) cm', type: 'number', min: 1, max: 400, step: 1 },
  ...
  calculateCY(u, H) {
    const H2 = BasePart.cm(this.params.H1);
    const bot0H = -H2 / 2;
    const top0H = H2 / 2;
